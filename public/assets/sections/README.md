...
| `clinic-interiors/` | **Real clinic** — reception, lounge, hallway, IV, retail | **`clinicInteriorImages.ts`** |
| `retail/` | Supplements, injection bar, PatientFi displays | **`retailImages.ts`** |
