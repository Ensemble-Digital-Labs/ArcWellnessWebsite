...
function CreamPlate({
  ...
  return (
    ...
    >
      {tileMedia ? (
        <CreamPlateTiledMedia src={emsculptNeoCreamPlate.src} />
      ) : stableMedia ? (
            ...
            >
              <div className="flex h-full flex-col items-center text-center">
                <EmblemIcon
                  ...
                  plate
                  className="h-24 w-24 sm:h-28 sm:w-28 md:h-[7.25rem] md:w-[7.25rem]"
                  iconClassName={emsculptNeoHero.poweredByIconClassName}
                />
        ...
        >
          ...
          <section className="relative z-10 px-6 py-16 sm:px-10 sm:py-20 md:px-12 md:py-24">
            ...
            >
              ...
              {/* EmSculpt Neo: 5 differentiators; row-2 pair centered under 3-up */}
