...
const thumbByHrefExtra: Record<string, string> = {
  ...
  "/library/desk": CLINIC_INTERIOR_IMAGES.hallwayAccentSeating,
  "/library/education": CLINIC_INTERIOR_IMAGES.hallwayAccentSeating,
  "/library/table": CLINIC_INTERIOR_IMAGES.consultationLounge,
...
const thumbByLabelAlias: Record<string, string> = {
  ...
  "from the arc desk": CLINIC_INTERIOR_IMAGES.hallwayAccentSeating,
  education: CLINIC_INTERIOR_IMAGES.hallwayAccentSeating,
  "from the arc table": CLINIC_INTERIOR_IMAGES.consultationLounge,
