    ...
    <section id="services" className="scroll-mt-28 border-t border-arc-charcoal/10 bg-arc-charcoal py-14 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-serif text-2xl font-semibold leading-snug text-[#f0e3d7] sm:text-3xl md:text-[2.1rem]">
          ...
          {slides.map((slide) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2 p-4 sm:p-5">
                ...
                <h3 className="font-serif text-lg font-semibold text-[#f0e3d7] sm:text-xl">{slide.title}</h3>
