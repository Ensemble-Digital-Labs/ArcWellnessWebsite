...
/** Fluid hero height — scales with viewport; caps at 56rem so very tall monitors stay editorial, not endless. */
const SHOWCASE_HERO_MIN_H = "min-h-[min(92dvh,56rem)]";
  ...
  return (
    <section className={`relative overflow-hidden bg-arc-charcoal ${SHOWCASE_HERO_MIN_H}`}>
      ...
      <div className={`relative z-[1] flex flex-col ${SHOWCASE_HERO_MIN_H}`}>
        {/* Top mastheads */}
        <div className="flex items-start justify-between gap-3 px-4 pb-2 pt-2.5 sm:gap-4 sm:px-8 sm:pb-3 sm:pt-3 lg:px-10 lg:pt-4">
          ...
          <div className="max-w-[min(100%,15rem)] text-right sm:max-w-[min(100%,16rem)]">
            ...
            <blockquote className="mt-1.5 font-serif text-[12px] italic leading-snug text-white/92 sm:mt-2 sm:text-[13px] md:text-[0.9rem]">
              “{c.quote}”
            </blockquote>
          </div>
        </div>
        ...
        <div className="flex min-h-0 flex-1 flex-col justify-center px-4 py-1 sm:px-8 sm:py-2 lg:px-10">
        ...
        <div className="flex w-full min-w-0 justify-end px-4 pb-3 pt-2 sm:px-8 sm:pb-4 sm:pt-3 lg:px-10">
          <div className="flex max-w-full flex-wrap items-center justify-end gap-3 sm:gap-4">
            ...
            <Link
              ...
              className="inline-flex max-w-[min(100%,14.5rem)] items-center gap-2 text-right font-sans text-[9px] font-semibold uppercase leading-snug tracking-[0.2em] text-white/92 sm:max-w-none sm:gap-2.5 sm:text-[10px] sm:leading-normal sm:tracking-[0.24em]"
            >
