export const financingPage = {
  ...
  hero: {
    eyebrow: "Financing",
    /** Short Contact-style TitleEmphasis pair (silk hero). */
    title: "Payment",
    titleEmphasis: "plans",
  ...
  options: [
    {
      ...
      body: "Structured options discussed during your consult, no pressure, clear terms.",
    },
    {
      title: "PatientFi",
      body: "Third-party financing for qualified applicants, apply with guidance from our team.",
    },
    {
      title: "Cherry",
      body: "Flexible payment plans designed for healthcare and wellness services.",
    },
  ],
} as const;
